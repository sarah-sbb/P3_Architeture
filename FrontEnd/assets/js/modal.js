...
export function displayModalGallery(data) {
    ...
    // ici ajouter modalGallery.appendChild(line)
        // Créer l'élément line et l'ajouter à la galerie modale
...
function updateModalGallery() {
    ...
    // Recharger la galerie modale avec les données mises à jour
...
function createPhotoForm(categories) {
    ...
    // Créer l'élément line pour le formulaire

    // const formLine = document.createElement('span');
    // formLine.classList.add('line');
